...
> <p style='font-size:20px;color:lawngreen;'> 📝Note:</p>
>
...
<img src="https://render.githubusercontent.com/render/math?math=0.1 = \frac{1}{10} = 0*2^{-1} + 0*2^{-2} + 0*2^{-3} + 1*2^{-4} + 1*2^{-5} + ... = 00011(0011) ">