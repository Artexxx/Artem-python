""" Лавинный эффект позволяет координально изменять зашифрованное сообщение
    даже при незначительном редактировании открытого сообщения"""
...
"""
m – начало символов по ASCII таблице
n – конец символов по ASCII таблице,
