"""
RSA —  крипт. алгоритм с открытым ключом, основывающийся на вычислительной сложности задачи факторизации больших целых чисел
"""
...
def generateKeys(minP, maxP, maxN):
    ...
    try:
        ...
        return generateKeys(minP, maxP, maxN)
