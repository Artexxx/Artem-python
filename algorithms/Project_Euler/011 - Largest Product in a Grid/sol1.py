"""
Каково наибольшее произведение 4 соседних чисел (по горизонтали,
вертикали или по диагонали) в этом массиве 20х20?
"""
...
def solution(grid: list = GRID) -> int:
    """Возвращает наибольшее произведение 4 соседних чисел (по горизонтали, вертикали или по диагонали) в 2-D квадратном массиве grid
